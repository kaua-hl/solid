...
var ShareButtonTwitter = /** @class */ (function (_super) {
    ...
    function ShareButtonTwitter(eventHandler, clazz) {
        return _super.call(this, eventHandler, clazz) || this;
    }
    ShareButtonTwitter.prototype.createAction = function () {
        return function () { return window.print(); };
    };
